export const mockDocuments = [
  {
    ...
    content: `
      <p>The objective of this project is to build a robust and scalable collaborative document editor that supports real-time editing and role-based access.</p>
      <h3>Goals:</h3>
      <ul>
        <li>Enable real-time collaboration</li>
        <li>Support for multiple user roles (Editor, Reviewer, Viewer, Admin)</li>
        <li>Commenting and document history</li>
  ...
  },
  {
    ...
    content: `
      ...
      <p>They are crucial for tracking progress on tasks, maintaining accountability, and avoiding miscommunication, making them an essential tool for effective collaboration and project management.</p>
      <h3>Action Items:</h3>
      <ul>
        <li>Finalize wireframes by August 5</li>
  ...
  },
  {
    ...
    content: `
      ...
      <h3>Phases:</h3>
      <ol>
        <li><strong>Phase 1 – Setup:</strong> Project scaffolding, environment setup, and dependency installation.</li>
        <li><strong>Phase 2 – Core Features:</strong> Implement document editing, real-time presence, and comments.</li>
        <li><strong>Phase 3 – Access Control:</strong> Add role-based permissions and admin tools.</li>
